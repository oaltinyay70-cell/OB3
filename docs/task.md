...
## Phase 0: Foundation
- [/] Discover & brief project (discovery questions, asset inventory, project brief)
- [ ] Read & understand orchestrator skill workflow
- [ ] Set up 8-agent roster with skill-based roles
- [ ] Parse rulebook (V3.1-D10.pdf) into structured markdown
- [ ] Decide tech stack details (Flutter confirmed, architecture patterns TBD)
